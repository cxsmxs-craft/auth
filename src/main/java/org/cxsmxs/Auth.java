...
import org.cxsmxs.commands.*;
import org.cxsmxs.listeners.*;
...
public final class Auth extends Async {
    ...
    private void setupMySQL() {
        try {
            ...
            conn.createStatement().execute("CREATE TABLE IF NOT EXISTS auth_players(uuid CHAR(36) NOT NULL PRIMARY KEY, algo CHAR(20) NOT NULL, hash CHAR(200) NOT NULL, salt CHAR(200) NOT NULL, ip CHAR(39), date CHAR(20) NOT NULL)");
            conn.close();
        } catch (SQLException ignored) {
            conn = null;
        }
